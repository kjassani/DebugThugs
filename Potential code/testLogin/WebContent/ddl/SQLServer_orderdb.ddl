...
INSERT INTO category(categoryName) VALUES ('Mystical Potions');
INSERT INTO category(categoryName) VALUES ('Ethereal Brews');
INSERT INTO category(categoryName) VALUES ('Otherworldly Elixirs');
INSERT INTO category(categoryName) VALUES ('Harvested Wonders');
INSERT INTO category(categoryName) VALUES ('Spectral Delights');
INSERT INTO category(categoryName) VALUES ('Marine Marvels');
INSERT INTO category(categoryName) VALUES ('Divine Confections');
INSERT INTO category(categoryName) VALUES ('Culinary Alchemy');

INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Levitation Potion", 1, "A potion that allows temporary levitation", 10.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Moonlit Elixir", 2, "A brew that glows in the moonlight", 8.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Eternal Essence", 3, "An elixir with timeless properties", 15.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Enchanted Seeds", 4, "Seeds that grow magical plants", 5.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Spectral Steak", 5, "Meat with a ghostly flavor", 12.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Mermaid's Bounty", 6, "Seafood from the depths of the ocean", 18.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Nectar of Bliss", 7, "Confections that bring joy and delight", 7.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Wizard's Mix", 8, "A blend of rare grains for magical recipes", 9.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Shadowy Shroud", 1, "Cloak yourself in shadows with this potion", 14.99);
INSERT INTO product(productName, categoryId, productDesc, productPrice) VALUES ("Phoenix Feather Tea", 2, "Tea made from the feathers of a phoenix", 11.99);
...
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 8, 2, 21.05)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 9, 4, 14);
